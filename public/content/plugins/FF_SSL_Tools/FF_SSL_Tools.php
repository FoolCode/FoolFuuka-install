...
class FF_SSL_Tools extends Plugins_model
{
	...
	function initialize_plugin()
	{
		...
		{
			Plugins::register_controller_function($this, array('admin', 'plugins', 'ssl_tools'), 'manage');
		...
		Plugins::register_hook($this, 'ff_my_controller_after_load_settings', 2, function(){
			$CI = & get_instance();
		...
		Plugins::register_hook($this, 'fu_themes_generic_top_nav_buttons', 4, function($top_nav){
		...
		Plugins::register_hook($this, 'fu_themes_generic_bottom_nav_buttons', 4, function($top_nav){
