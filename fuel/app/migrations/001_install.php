...
class Install
{
    ...
    function up()
    {
		...
		), array('session_id'), true, 'innodb', 'utf8mb4_unicode_ci');
		...
		\DBUtil::create_table('plugins', array(
			...
			'revision' => array('type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => null, 'null' => true)
		...
		\DBUtil::create_table('users', array(
            ...
            'new_email' => array('type' => 'varchar', 'constraint' => 255, 'default' => null, 'null' => true),
			'new_email_key' => array('type' => 'varchar', 'constraint' => 128, 'default' => null, 'null' => true),
			'new_email_time' => array('type' => 'int', 'constraint' => 11, 'unsigned' => true, 'default' => null, 'null' => true),
			'activated' => array('type' => 'tinyint', 'constraint' => 2, 'unsigned' => true),
			'activation_key' => array('type' => 'varchar', 'constraint' => 128, 'null' => true, 'default' => null),
			'new_password_key' => array('type' => 'varchar', 'constraint' => 128, 'null' => true, 'default' => null),
			'new_password_time' => array('type' => 'int', 'constraint' => 11, 'null' => true, 'default' => null),
			'deletion_key' => array('type' => 'varchar', 'constraint' => 128, 'null' => true, 'default' => null),
			'deletion_time' => array('type' => 'int', 'constraint' => 11, 'null' => true, 'default' => null),
		...
		), array('login_hash'), true, 'innodb', 'utf8_unicode_ci');
