...
return array(
	...
	*/
	...
	'cookie'			=> array(
		'cookie_name'		=> 'foolframeid',				// name of the session cookie for cookie based sessions
						),

	// specific configuration settings for file based sessions
	'file'				=> array(
		'cookie_name'		=> 'foolframeid',				// name of the session cookie for file based sessions
	...
	'memcached'			=> array(
		'cookie_name'		=> 'foolframeid',				// name of the session cookie for memcached based sessions
	...
	'db'			=> array(
		'cookie_name'		=> 'foolframeid',				// name of the session cookie for database based sessions
	...
	'redis'			=> array(
		'cookie_name'		=> 'foolframeid',				// name of the session cookie for redis based sessions
