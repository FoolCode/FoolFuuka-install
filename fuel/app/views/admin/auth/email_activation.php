...
Looks like you have registered to the <?php $site ?> and now you need to activate your account! (ﾟДﾟ≡ﾟДﾟ)
<br/><br/>
If this mail was sent to you by mistake, you should ignore it, delete it if you wish. Sorry for bothering. （´・ω・`）
<br/><br/>
Otherwise, you can activate your account by just following <strong><a href="<?php $activation_link ?>">this link</a></strong>.  ( ゜∀゜)アハハ八八ノヽノヽノヽノ ＼ ／ ＼／ ＼
<br/><br/>
