...
<?php if ($error === true) : ?>
<p class="text-warning" style="text-align: center;"><?= e(__('Sorry, your server environment failed to pass all of the minimum requirements needed to run the software properly. Please review the information above and ensure that your server environment is properly configured.')) ?></p>
<?php else : ?>
<p class="text-success" style="text-align: center;"><?= e(__('Congratulations! Your server environment meets all of the minimum requirements to run the software properly.')) ?></p>
